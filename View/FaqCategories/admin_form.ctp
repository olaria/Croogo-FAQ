...
if ($this->request->params['action'] == 'admin_edit') {
    $this->Html
        ...
        ->addCrumb(
            ...
            array('plugin' => 'faq', 'controller' => 'faq_categories', 'action' => 'index')
        )
        ->addCrumb($this->request->data['FaqCategory']['name'], $this->here);
}
    ...
    <div class="row-fluid">
        <div class="span8">
            <ul class="nav nav-tabs">
                <?php
                echo $this->Croogo->adminTab(__d('croogo', 'FAQ Category'), '#faq_category-basic');
            ...
            <div class="tab-content">
                ...
                <div id="faq_category-basic" class="tab-pane">
                    <?php
